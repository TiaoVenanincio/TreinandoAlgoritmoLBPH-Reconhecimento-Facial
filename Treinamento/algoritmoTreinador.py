...
face_cascade =  cv2.CascadeClassifier('.\Treinamento\haarcascade_frontalface_default.xml')
...
def treina_algoritmo(codigo):
    ...
    rostos_conhecidos = '.\Treinamento\cod' + str(codigo)
    ...
    #diretorio das imagens p/ treinamento
    rostos_desconhecidos = '.\Treinamento\FacesTreino'
