...
def tiraFoto(codigo):
    ...
    diretorio = '.\data\Faces_conhecidas' + '\cod' + str(codigo)
    os.makedirs(diretorio, exist_ok=True)

    #algoritmo para tirar as 50 fotos, com limite de frames (5000) para nao rodar infinitamente
