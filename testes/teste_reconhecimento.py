...
path_algoritmo = '.\data\Algoritmos_treinados\cod'+str(codigo)+'\cod'+str(codigo)+'_treinado.xml'
lbph_face_classifier.read(path_algoritmo)

paths = os.listdir('./data/Imagens_teste/')
for path in paths:  
    caminho = './data/Imagens_teste/' + path  
